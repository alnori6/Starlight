        ...
        ZStack{
            ...
            VStack{
                ...
                ZStack{
                    ...
                    Text("Is an emotional response to frustration and injustice, often stemming from feelings of powerlessness.  ")
                ...
                ZStack{
                    NavigationLink(destination: AngerView()) {
                        Image("next")
...
#Preview {
    AngerEmotion().environmentObject(AudioManager())
}
