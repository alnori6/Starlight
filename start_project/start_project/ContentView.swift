            ...
            ZStack {
                ...
                VStack {
                    TabView(selection: $selectedTab) {
                        EmotionView(emotion: "Sad", imageName: "sit_sad", destination: AnyView(SadTabView()), selectedTab: $selectedTab)
                            .tag(0)

                        EmotionView(emotion: "Angry", imageName: "sit_angry", destination: AnyView(AngeryTabView()), selectedTab: $selectedTab)
                            .tag(1)

                        EmotionView(emotion: "Anxious", imageName: "sit_grumpy", destination: AnyView(AnxietyTabView()), selectedTab: $selectedTab)
                            .tag(2)

                        EmotionView(emotion: "Calm", imageName: "sit_smile", destination: AnyView(CalmTabView()), selectedTab: $selectedTab)
                            .tag(3)
                    }
